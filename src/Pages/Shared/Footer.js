...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-500 text-white">
            ...
            <div className="py-6 text-sm text-center text-white">Copyright©2022 || Md Anik Ahammed Khan || All rights reserved.</div>
        </footer>
    );
};
