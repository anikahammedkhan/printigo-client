...
const Quality = () => {
    return (
        <section className="p-6 my-6">
            <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4 shadow-2xl p-4">
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100 shadow-2xl">
                ...
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100 shadow-2xl">
                    ...
                    <div className="flex flex-col justify-center align-middle">
                        <p className="text-3xl font-semibold leading-none">143</p>
                ...
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100 shadow-2xl">
                    ...
                    <div className="flex flex-col justify-center align-middle">
                        <p className="text-3xl font-semibold leading-none">7%</p>
